...
$$.LinkedHashMapCell = {"": "Object;_key<,_value@,_liblib2$_next@,_liblib2$_previous@"};
  ...
  moveNext$0: function() {
    ...
    if (this._modifications !== t1._modifications)
      ...
      if (t1 == null) {
        ...
        this._cell = this._cell.get$_liblib2$_next();
        return true;
      }
    }
  },
...
$$.LinkedHashSetCell = {"": "Object;_liblib2$_element<,_liblib2$_next@,_liblib2$_previous@"};
...
$$._Manager = {"": "Object;nextIsolateId,currentManagerId,nextManagerId,currentContext,rootContext,topEventLoop,fromCommandLine,isWorker,supportsWorkers,isolates,mainManager,managers,entry",
  ...
  maybeCloseWorker$0: function() {
    ...
    if (this.isWorker === true) {
      t1 = this.isolates;
      t1.get$isEmpty;
      t1 = t1._liblib2$_length === 0 && this.topEventLoop.activeTimerCount === 0;
    } else
      t1 = false;
    if (t1) {
      t1 = this.mainManager;
...
$$._EventLoop = {"": "Object;events,activeTimerCount",
  ...
  dequeue$0: function() {
    var t1 = this.events;
    if (t1._liblib2$_head === t1._liblib2$_tail)
      return;
...
$$.ReceivePortImpl = {"": "Object;_liblib8$_id<,_liblib8$_callback<",
  ...
  ReceivePortImpl$0: function() {
    $.register$2$x($._globalState().currentContext, this._liblib8$_id, this);
  },
  $isReceivePort: true
};
...
$$.LinkedHashMap = {"": "Object;_liblib2$_length,_strings,_nums,_rest,_first,_last,_modifications",
  ...
  _newLinkedCell$2: function(key, value) {
    ...
    if (this._first == null) {
      ...
      last = this._last;
      cell._liblib2$_previous = last;
      last.set$_liblib2$_next(cell);
      this._last = cell;
    }
    this._liblib2$_length = this._liblib2$_length + 1;
    this._modifications = this._modifications + 1 & 67108863;
  ...
  _unlinkCell$1: function(cell) {
    var previous, next;
    previous = cell.get$_liblib2$_previous();
    next = cell.get$_liblib2$_next();
    if (previous == null)
      this._first = next;
    else
      previous.set$_liblib2$_next(next);
    if (next == null)
      this._last = previous;
    else
      next.set$_liblib2$_previous(previous);
    this._liblib2$_length = this._liblib2$_length - 1;
    this._modifications = this._modifications + 1 & 67108863;
  },
...
$$.ListMixin = {"": "Object;",
  ...
  every$1: function(receiver, test) {
    ...
    $length = this.get$length(receiver);
    if (typeof $length !== "number")
      return this.every$1$bailout(1, test, receiver, $length);
    for (i = 0; i < $length; ++i) {
...
$$.ListQueue = {"": "IterableBase;_table,_liblib2$_head,_liblib2$_tail,_modificationCount",
  get$iterator: function(_) {
  ...
  forEach$1: function(_, action) {
    ...
    for (i = this._liblib2$_head; i !== this._liblib2$_tail; i = (i + 1 & this._table.length - 1) >>> 0) {
      t1 = this._table;
      if (i < 0 || i >= t1.length)
        throw $.ioore(i);
      action.call$1(t1[i]);
  ...
  get$isEmpty: function(_) {
    return this._liblib2$_head === this._liblib2$_tail;
  },
  get$length: function(_) {
    return $.$and$n($.$sub$n(this._liblib2$_tail, this._liblib2$_head), this._table.length - 1);
  },
  elementAt$1: function(_, index) {
    var t1, t2, t3;
    t1 = $.getInterceptor$n(index);
    if (t1.$lt(index, 0) || t1.$gt(index, $.$and$n($.$sub$n(this._liblib2$_tail, this._liblib2$_head), this._table.length - 1)))
      throw $.wrapException($.RangeError$range(index, 0, $.$and$n($.$sub$n(this._liblib2$_tail, this._liblib2$_head), this._table.length - 1)));
    t1 = this._table;
    t2 = this._liblib2$_head;
    if (typeof index !== "number")
      throw $.iae(index);
    t3 = t1.length;
    t2 = (t2 + index & t3 - 1) >>> 0;
  ...
  toList$1$growable: function(_, growable) {
    ...
    if (growable) {
      ...
      $.JSArray_methods.set$length(list, $.$and$n($.$sub$n(this._liblib2$_tail, this._liblib2$_head), this._table.length - 1));
    } else {
      t1 = $.$and$n($.$sub$n(this._liblib2$_tail, this._liblib2$_head), this._table.length - 1);
      $arguments = this.$asListQueue;
      arguments0 = $.getRuntimeTypeInfo(this);
      if ($arguments != null && $arguments.constructor === Array)
        ;
  ...
  addAll$1: function(_, elements) {
    ...
    if (typeof elements === "object" && elements !== null && (elements.constructor === Array || !!$.getInterceptor(elements).$isList)) {
      ...
      t1 = $.$sub$n(this._liblib2$_tail, this._liblib2$_head);
      t2 = this._table;
      t3 = t2.length;
      ...
      if (t1 >= t3) {
        ...
        this._liblib2$_tail = $.$add$ns(this._liblib2$_tail, addCount);
      } else {
  ...
  clear$0: function(_) {
    ...
    if (i !== t1) {
      ...
      this._liblib2$_tail = 0;
      this._liblib2$_head = 0;
      this._modificationCount = this._modificationCount + 1;
    }
  },
  toString$0: function(_) {
  ...
  removeFirst$0: function() {
    var t1, t2, t3, result;
    if (this._liblib2$_head === this._liblib2$_tail)
      throw $.wrapException($.StateError$("No elements"));
    this._modificationCount = this._modificationCount + 1;
    t1 = this._table;
    t2 = this._liblib2$_head;
    ...
    if (t2 < 0 || t2 >= t3)
      throw $.ioore(t2);
    result = t1[t2];
    this._liblib2$_head = (t2 + 1 & t3 - 1) >>> 0;
    return result;
  },
  removeLast$0: function(_) {
    ...
    if (this._liblib2$_head === this._liblib2$_tail)
      throw $.wrapException($.StateError$("No elements"));
    this._modificationCount = this._modificationCount + 1;
    this._liblib2$_tail = $.$and$n($.$sub$n(this._liblib2$_tail, 1), this._table.length - 1);
    t1 = this._table;
    t2 = this._liblib2$_tail;
  ...
  _add$1: function(element) {
    ...
    if (t2 >>> 0 !== t2 || t2 >= t1.length)
      throw $.ioore(t2);
    t1[t2] = element;
    this._liblib2$_tail = $.$and$n(t2 + 1, this._table.length - 1);
    if (this._liblib2$_head === this._liblib2$_tail)
      this._grow$0();
    this._modificationCount = this._modificationCount + 1;
  },
  _remove$1: function(offset) {
    ...
    t2 = t1.length;
    mask = t2 - 1;
    t3 = this._liblib2$_head;
    startDistance = (offset - t3 & mask) >>> 0;
    t4 = this._liblib2$_tail;
    if (typeof t4 !== "number")
    ...
    if (startDistance < (t4 - offset & mask) >>> 0) {
      ...
      if (t3 < 0 || t3 >= t2)
        throw $.ioore(t3);
      t1[t3] = null;
      this._liblib2$_head = (t3 + 1 & mask) >>> 0;
      return (offset + 1 & mask) >>> 0;
    } else {
      this._liblib2$_tail = (t4 - 1 & mask) >>> 0;
      for (t1 = this._table, t2 = t1.length, i = offset; t3 = this._liblib2$_tail, i !== t3; i = nextOffset) {
  ...
  _remove$1$bailout: function(state0, offset, mask, startDistance, t1) {
    switch (state0) {
      case 0:
        ...
        startDistance = (offset - this._liblib2$_head & mask) >>> 0;
        t1 = this._liblib2$_tail;
      case 1:
        state0 = 0;
      case 2:
        ...
        if (state0 === 0 && startDistance < $.$and$n($.$sub$n(t1, offset), mask)) {
          for (t1 = this._table, t2 = t1.length, i = offset; t3 = this._liblib2$_head, i !== t3; i = prevOffset) {
            prevOffset = (i - 1 & mask) >>> 0;
            if (prevOffset < 0 || prevOffset >= t2)
              throw $.ioore(prevOffset);
            t3 = t1[prevOffset];
          ...
          switch (state0) {
            ...
            case 2:
              state0 = 0;
              this._liblib2$_tail = $.$and$n($.$sub$n(t1, 1), mask);
              for (t1 = this._table, t2 = t1.length, i = offset; t3 = this._liblib2$_tail, i !== t3; i = nextOffset) {
                nextOffset = (i + 1 & mask) >>> 0;
                if (nextOffset < 0 || nextOffset >= t2)
                  throw $.ioore(nextOffset);
  ...
  _writeToList$1: function(target) {
    ...
    if ($.JSInt_methods.$le(t1, t2)) {
      $length = $.$sub$n(t2, t1);
      $.JSArray_methods.setRange$4(target, 0, $length, this._table, this._liblib2$_head);
      return $length;
    } else {
      t2 = this._table;
      ...
      return $.$add$ns(this._liblib2$_tail, firstPartSize);
    }
  },
  _preGrow$1: function(newElementCount) {
    ...
    t1 = $arguments == null ? null : $arguments[0];
    newTable.$builtinTypeInfo = [t1];
    this._liblib2$_tail = this._writeToList$1(newTable);
    this._table = newTable;
    this._liblib2$_head = 0;
  },
...
$$._MultiElementCssClassSet = {"": "CssClassSetImpl;_elementIterable,_elementCssClassSetIterable",
  ...
  _MultiElementCssClassSet$1: function(_elementIterable) {
    this._elementCssClassSetIterable = $.map$1$ax($.List_List$from(this._elementIterable, true, null), new $._MultiElementCssClassSet_closure());
  }
};
...
$$._AttributeClassSet = {"": "CssClassSetImpl;_liblib6$_element",
  readClasses$0: function() {
    ...
    classname = $._ElementAttributeMap$(this._liblib6$_element)._element.getAttribute("class");
    s = $.LinkedHashSet$($.JSString);
    if (classname == null)
      return s;
  ...
  writeClasses$1: function(s) {
    $._ElementAttributeMap$(this._liblib6$_element)._element.setAttribute("class", s.join$1(s, " "));
  }
};
...
$$.Dropdown = {"": "WebComponent;__t,_isShown,_host,_shadowRoots,_generatedRoots",
  ...
  created$0: function() {
    ...
    $.get$onKeyDown$x(this.get$host(this)).listen$1(this.get$_onKeyDown());
  },
  ...
  _onClick$1: function($event) {
    ...
    if (t2) {
      ...
      if (target != null && $.$eq($.$index$asx(t2.get$dataset(target), "toggle"), "dropdown")) {
...
$$.Board = {"": "Object;cells>",
  ...
  isEmpty$0: function(_) {
    return $.every$1$ax(this.cells, new $.Board_isEmpty_closure());
  },
  get$isEmpty: function(receiver) {
    return new $.BoundClosure$i0(this, "isEmpty$0", receiver);
  },
  noMoves$0: function() {
    return $.any$1$ax(this.cells, new $.Board_noMoves_closure()) !== true;
  },
  Board$2: function(width, height) {
    this.cells = $.List_List$generate(height, new $.Board_closure(width, $.Random_Random(null)), true, [$.JSArray, $.Cell]);
  }
};

$$.Board_closure = {"": "Closure;width_0,rng_1",
  call$1: function(i) {
    return $.List_List$generate(this.width_0, new $.Board__closure(this.rng_1, i), true, $.Cell);
  },
  $isFunction: true
};

$$.Board__closure = {"": "Closure;rng_2,i_3",
  call$1: function(j) {
    var max, t1;
    max = $.numColours;
    ...
    if (t1.$gt(max, 4294967295))
      max = 4294967295;
    return $.Cell$((Math.random() * max >>> 0) + 1, this.i_3, j);
  },
  $isFunction: true
};

$$.Board_isEmpty_closure = {"": "Closure;",
  call$1: function(r) {
    return $.every$1$ax(r, new $.Board_isEmpty__closure());
  },
  $isFunction: true
};

$$.Board_isEmpty__closure = {"": "Closure;",
  call$1: function(cell) {
    return $.$eq(cell.get$contents(), 0);
  },
  $isFunction: true
};

$$.Board_noMoves_closure = {"": "Closure;",
  call$1: function(r) {
    return $.any$1$ax(r, new $.Board_noMoves__closure());
  },
  $isFunction: true
};

$$.Board_noMoves__closure = {"": "Closure;",
  call$1: function(cell) {
    return $.hasMinimumChain(cell.get$row(), cell.get$col());
  },
  $isFunction: true
};

$$.Cell = {"": "Object;contents@,row<,col<",
  toString$0: function(_) {
    return $.toString$0(this.contents);
  },
  toJson$0: function() {
    return $.toString$0(this.contents);
  },
...
$$.Yx = {"": "Object;y>,x>",
  ...
  get$hashCode: function(_) {
    return $.get$hashCode$(this.x);
  },
  toString$0: function(_) {
    return "(y" + $.S(this.y) + ",x" + $.S(this.x) + ")";
  },
  adjacent$0: function() {
    var t1, t2;
    t1 = this.y;
    t2 = this.x;
    return [$.Yx$(t1, $.$add$ns(t2, 1)), $.Yx$(t1, $.$sub$n(t2, 1)), $.Yx$($.$add$ns(t1, 1), t2), $.Yx$($.$sub$n(t1, 1), t2)];
  },
  validAdjacent$0: function() {
    return $.WhereIterable$(this.adjacent$0(), new $.Yx_validAdjacent_closure(), null);
  },
  $isYx: true
};

$$.Yx_validAdjacent_closure = {"": "Closure;",
  call$1: function(yx) {
    var t1, t2, t3, t4;
    t1 = $.getInterceptor$x(yx);
    t2 = t1.get$x(yx);
    t3 = $.getInterceptor$n(t2);
    if (t3.$ge(t2, 0)) {
      t1 = t1.get$y(yx);
      t4 = $.getInterceptor$n(t1);
      t1 = t4.$ge(t1, 0) && t4.$lt(t1, $.boardH) && t3.$lt(t2, $.boardW);
    } else
      t1 = false;
    return t1;
  },
...
$$.clicked_closure = {"": "Closure;",
  call$1: function(yx) {
    var t1, t2, t3;
    t1 = $.board;
    t1.setContentYx$2;
    t2 = $.getInterceptor$x(yx);
    t3 = t2.get$y(yx);
    t2 = t2.get$x(yx);
    $.$index$asx($.$index$asx(t1.cells, t3), t2).set$contents(0);
    return 0;
  },
  $isFunction: true
};

$$.generateChain_isValid = {"": "Closure;selected_0",
  call$1: function(yx) {
    return !$.JSArray_methods.contains$1(this.selected_0, yx);
  },
  $isFunction: true
};

$$.generateChain_closure = {"": "Closure;agenda_1",
  call$1: function(yx) {
    return this.agenda_1.push(yx);
  },
  $isFunction: true
};

$$.hasMinimumChain_closure = {"": "Closure;contentType_0",
  call$1: function(yx) {
    var t1, t2, t3;
    t1 = $.board;
    t1.getContentYx$1;
    ...
    t3 = t2.get$y(yx);
    t2 = t2.get$x(yx);
    return $.$eq($.$index$asx($.$index$asx(t1.cells, t3), t2).get$contents(), this.contentType_0);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure3 = {"": "Closure;__html0_1,__html1_2",
  call$3: function($$list, $$index, __t) {
    var row, __e6;
    row = $.$index$asx($$list, $$index);
    __e6 = this.__html0_1.cloneNode(true);
    __t.loopIterateAttr$3(__e6, new $.init_autogenerated__closure(row), new $.init_autogenerated__closure0(this.__html1_2));
    $.addAll$1$ax(__t, [document.createTextNode("\n          "), __e6, document.createTextNode("\n        ")]);
  },
  $isFunction: true
};

$$.init_autogenerated__closure = {"": "Closure;row_3",
  call$0: function() {
    return this.row_3;
  },
  $isFunction: true
...
$$.init_autogenerated__closure0 = {"": "Closure;__html1_4",
  call$3: function($$list, $$index, __t) {
    var t1, cell, __e5, t2;
    t1 = {};
    cell = $.$index$asx($$list, $$index);
    t1.__e4_0 = null;
    __e5 = $.clone$1$x(this.__html1_4, true);
    t1.__e4_0 = $.$index$asx($.get$nodes$x(__e5), 1);
    __t.listen$2($.get$onClick$x(t1.__e4_0), new $.init_autogenerated___closure(cell));
    __t.oneWayBind$4(new $.init_autogenerated___closure0(cell), new $.init_autogenerated___closure1(t1), false, false);
    t2 = $.CellComponent$();
    t2.set$host(t2, t1.__e4_0);
    __t.component$1(t2);
...
$$.init_autogenerated___closure = {"": "Closure;cell_5",
  call$1: function($$event) {
    var t1 = this.cell_5;
    $.clicked(t1.get$row(), t1.get$col());
  },
  $isFunction: true
};

$$.init_autogenerated___closure0 = {"": "Closure;cell_6",
  call$0: function() {
    return this.cell_6.get$contents();
  },
  $isFunction: true
};

$$.init_autogenerated___closure1 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if (!$.$eq($.get$xtag$x(t1.__e4_0).get$contents(), e))
      $.get$xtag$x(t1.__e4_0).set$contents(e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure5 = {"": "Closure;",
  call$0: function() {
    return $.isGameOver === true && $.boardClear !== true;
  },
  $isFunction: true
};

$$.init_autogenerated_closure6 = {"": "Closure;__html4_7",
  call$1: function(__t) {
    $.add$1$ax(__t, $.clone$1$x(this.__html4_7, true));
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure8 = {"": "Closure;__html6_8",
  call$1: function(__t) {
    $.add$1$ax(__t, $.clone$1$x(this.__html6_8, true));
  },
  $isFunction: true
};

$$.CellComponent = {"": "WebComponent;__e13,__e14,_liblib0$__t,contents@,_host,_shadowRoots,_generatedRoots",
  created_autogenerated$0: function() {
    var root, t1, t2, t3;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
    t1.$indexSet(t1, "x-game-cell", root);
    this._liblib0$__t = $.Template$(root);
    t1 = $.getInterceptor$x(root);
    $.add$1$ax(t1.get$nodes(root), $.clone$1$x($.get$CellComponent___shadowTemplate(), true));
    this.__e13 = $.$index$asx(t1.get$nodes(root), 2);
    t2 = this._liblib0$__t;
    t3 = this.__e13;
    t2.conditional$3;
    t2.children.push($.ConditionalTemplate$(t3, new $.CellComponent_created_autogenerated_closure(this), new $.CellComponent_created_autogenerated_closure0(this)));
    this.__e14 = $.$index$asx(t1.get$nodes(root), 4);
    t1 = this._liblib0$__t;
    t3 = this.__e14;
    t1.conditional$3;
    t1.children.push($.ConditionalTemplate$(t3, new $.CellComponent_created_autogenerated_closure1(this), new $.CellComponent_created_autogenerated_closure2()));
...
$$.CellComponent_created_autogenerated_closure = {"": "Closure;this_0",
  call$0: function() {
    return $.$gt$n(this.this_0.get$contents(), 0);
  },
  $isFunction: true
};

$$.CellComponent_created_autogenerated_closure0 = {"": "Closure;this_1",
  call$1: function(__t) {
    var __e12 = $.clone$1$x($.get$CellComponent___html1(), true);
    __t.bindClass$3(__e12, new $.CellComponent_created_autogenerated__closure(this.this_1), false);
    $.add$1$ax(__t, __e12);
  },
  $isFunction: true
};

$$.CellComponent_created_autogenerated__closure = {"": "Closure;this_2",
  call$0: function() {
    return $.JSString_methods.$add("game-cell-", $.toString$0(this.this_2.get$contents()));
  },
  $isFunction: true
};

$$.CellComponent_created_autogenerated_closure1 = {"": "Closure;this_3",
  call$0: function() {
    return $.$eq(this.this_3.get$contents(), 0);
  },
  $isFunction: true
};

$$.CellComponent_created_autogenerated_closure2 = {"": "Closure;",
  call$1: function(__t) {
    $.add$1$ax(__t, $.clone$1$x($.get$CellComponent___html2(), true));
  },
  $isFunction: true
};
...
$$.LinkedListNode = {"": "Object;_previous?,_next?,_list<,_liblib1$_value",
  get$next: function() {
    return this._next;
  },
...
$$._AnimatingValues = {"": "Object;_liblib10$_element,_cleanupAction,_finishFunc,_completer,_timer",
  ...
  _AnimatingValues$_internal$3: function(_element, _cleanupAction, _finishFunc) {
    ...
    t1.$indexSet(t1, this._liblib10$_element, this);
  },
...
$$.Element = {"": "Node;$$dom_children:children=,id=,innerHtml:innerHTML},$$dom_className:className%,style=,tagName=",
...
$$.InputElement = {"": "Element;height=,type=,value%,width=", $isElement: true, $asElement: null, $isNode: true, $asNode: null};
...
$._ListQueueIterator$ = function(queue) {
  return new $._ListQueueIterator(queue, queue._liblib2$_tail, queue._modificationCount, queue._liblib2$_head, null);
};
...
$.Dropdown$ = function() {
  return new $.Dropdown(null, false, null, null, $.makeLiteralMap([]));
};

$.Dropdown_closeDropdowns = function() {
  var t1 = $.HtmlDocument_methods.queryAll$1(document, "[is=x-dropdown]");
  t1 = t1.where$1(t1, new $.Dropdown_closeDropdowns_closure());
  t1 = t1.map$1(t1, new $.Dropdown_closeDropdowns_closure0());
  t1.forEach$1(t1, new $.Dropdown_closeDropdowns_closure1());
};

$.Board$ = function(width, height) {
  var t1 = new $.Board(null);
  t1.Board$2(width, height);
  return t1;
};

$.Cell$ = function(contents, row, col) {
  return new $.Cell(contents, row, col);
};
...
$.newGame = function(colours, height, width) {
  $.Dropdown_closeDropdowns();
  $.score = 0;
  $.boardW = width;
  $.boardH = height;
...
$.clicked = function(row, col) {
  var chain, t1;
  chain = $.generateChain(row, col);
  t1 = chain.length;
  if (t1 > 1) {
    $.score = $.$add$ns($.score, t1 * (t1 - 1) + 1);
    $.IterableMixinWorkaround_forEach(chain, new $.clicked_closure());
    $.gravity();
    $.horizontalGravity();
    $.checkGameOver();
  }
...
$.gravity = function() {
  var changed, r, t1, c, t2, t3;
  for (changed = true; changed;)
    for (r = $.$sub$n($.boardH, 2), changed = false; r >= 0; --r)
      for (t1 = r + 1, c = 0; $.JSNumber_methods.$lt(c, $.boardW); ++c) {
        t2 = $.board;
        t2.getContent$2;
        if (!$.$eq($.$index$asx($.$index$asx(t2.cells, r), c).get$contents(), 0)) {
          t2 = $.board;
          t2.getContent$2;
          t2 = $.$eq($.$index$asx($.$index$asx(t2.cells, t1), c).get$contents(), 0);
        } else
          t2 = false;
        if (t2) {
          t2 = $.board;
          t2.getContent$2;
          t3 = $.$index$asx($.$index$asx(t2.cells, r), c).get$contents();
          t2.setContent$3;
          $.$index$asx($.$index$asx(t2.cells, t1), c).set$contents(t3);
          t3 = $.board;
          t3.setContent$3;
          $.$index$asx($.$index$asx(t3.cells, r), c).set$contents(0);
          changed = true;
        }
      }
};

$.horizontalGravity = function() {
  var changed, c, t1, t2, r, t3;
  for (changed = true; changed;)
    for (changed = false, c = 1; $.JSNumber_methods.$lt(c, $.boardW); ++c) {
      t1 = $.board;
      t2 = $.$sub$n($.boardH, 1);
      t1.getContent$2;
      if (!$.$eq($.$index$asx($.$index$asx(t1.cells, t2), c).get$contents(), 0)) {
        t1 = $.board;
        t2 = $.$sub$n($.boardH, 1);
        t1.getContent$2;
        t2 = $.$eq($.$index$asx($.$index$asx(t1.cells, t2), c - 1).get$contents(), 0);
        t1 = t2;
      } else
        t1 = false;
      if (t1)
        for (t1 = c - 1, r = 0; $.JSNumber_methods.$lt(r, $.boardH); ++r, changed = true) {
          t2 = $.board;
          t2.getContent$2;
          t3 = $.$index$asx($.$index$asx(t2.cells, r), c).get$contents();
          t2.setContent$3;
          $.$index$asx($.$index$asx(t2.cells, r), t1).set$contents(t3);
          t3 = $.board;
          t3.setContent$3;
          $.$index$asx($.$index$asx(t3.cells, r), c).set$contents(0);
        }
...
$.checkGameOver = function() {
  var t1 = $.board;
  if (t1.isEmpty$0(t1) === true) {
    $.score = $.$add$ns($.score, $.$mul$n($.boardW, $.boardH) * 3);
    $.boardClear = true;
    $.isGameOver = true;
  }
  if ($.board.noMoves$0())
...
$.generateChain = function(startRow, startCol) {
  var selected, agenda, searched, t1, contentType, current, t2, t3, $arguments, arguments0;
  selected = $.List_List($, $.Yx);
  selected.$builtinTypeInfo = [$.Yx];
  agenda = $.List_List($, $.Yx);
  agenda.$builtinTypeInfo = [$.Yx];
  searched = $.List_List($, $.Yx);
  searched.$builtinTypeInfo = [$.Yx];
  t1 = $.board;
  t1.getContent$2;
  contentType = $.$index$asx($.$index$asx(t1.cells, startRow), startCol).get$contents();
  if (typeof contentType !== "number")
    return $.generateChain$bailout(1, startRow, startCol, searched, agenda, selected, contentType);
  if (contentType === 0)
    return selected;
  agenda.push($.Yx$(startRow, startCol));
  for (; agenda.length > 0;) {
    current = $.JSArray_methods.get$last(agenda);
    t1 = $.board;
    t1.getContentYx$1;
    t2 = $.getInterceptor$x(current);
    t3 = t2.get$y(current);
    t2 = t2.get$x(current);
    if ($.$eq($.$index$asx($.$index$asx(t1.cells, t3), t2).get$contents(), contentType)) {
      selected.push(current);
      t1 = current.validAdjacent$0();
      $arguments = t1.$asIterableBase;
      arguments0 = $.getRuntimeTypeInfo(t1);
      if ($arguments != null && $arguments.constructor === Array)
        ;
        ...
        $arguments = typeof $arguments == "function" ? $arguments.apply(null, arguments0) : arguments0;
      t2 = $arguments == null ? null : $arguments[0];
      t2 = $.WhereIterable$(t1, new $.generateChain_isValid(selected), t2);
      t2.forEach$1(t2, new $.generateChain_closure(agenda));
    }
    searched.push(current);
    $.JSArray_methods.remove$1(agenda, current);
  }
  return selected;
};

$.generateChain$bailout = function(state0, startRow, startCol, searched, agenda, selected, contentType) {
  var current, t1, t2, t3, $arguments, arguments0;
  if ($.$eq(contentType, 0))
    return selected;
  agenda.push($.Yx$(startRow, startCol));
  for (; agenda.length > 0;) {
...
$.hasMinimumChain = function(row, col) {
  var t1, contentType;
  t1 = $.board;
  t1.getContent$2;
  contentType = $.$index$asx($.$index$asx(t1.cells, row), col).get$contents();
  if ($.$eq(contentType, 0))
    return false;
  t1 = $.Yx$(row, col).validAdjacent$0();
  return t1.any$1(t1, new $.hasMinimumChain_closure(contentType));
};

$.init_autogenerated = function() {
  var __root, __html0, __html1, __html2, __html3, __html4, __html5, __html6, __t, t1, __e3, t2, __e11, __binding8, __e9, __e10;
  __root = document.body;
  __html0 = document.createElement("tr");
  __html1 = $._ElementFactoryProvider_createElement_html("<td>\n              <div is=\"x-game-cell\"></div>\n            </td>");
  __html2 = $._ElementFactoryProvider_createElement_html("<span>Score: </span>");
  __html3 = $._ElementFactoryProvider_createElement_html("<span style=\"display:none\"></span>");
  __html4 = $._ElementFactoryProvider_createElement_html("<span style=\"float:right\" template=\"\" instantiate=\"if isGameOver &amp;&amp; !boardClear\">Game Over!</span>");
  __html5 = $._ElementFactoryProvider_createElement_html("<span style=\"display:none\"></span>");
  __html6 = $._ElementFactoryProvider_createElement_html("<span style=\"float:right\" template=\"\" instantiate=\"if isGameOver &amp;&amp; boardClear\">Complete Victory!</span>");
  __t = $.Template$(__root);
  __root.get$nodes;
  ...
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(__e3), 3)), 1)), new $.init_autogenerated_closure());
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(__e3), 3)), 3)), new $.init_autogenerated_closure0());
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(__e3), 3)), 5)), new $.init_autogenerated_closure1());
  t1 = $.Dropdown$();
  t1.set$host(t1, __e3);
  t2 = __t.children;
  t2.push($.ComponentItem$(t1));
  __root.get$nodes;
  t1 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (5 >= t1.length)
    throw $.ioore(5);
  t2.push($.LoopTemplateInAttribute$($.$index$asx($.get$nodes$x(t1[5]), 1), new $.init_autogenerated_closure2(), new $.init_autogenerated_closure3(__html0, __html1)));
  __root.get$nodes;
  t1 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (7 >= t1.length)
    throw $.ioore(7);
  __e11 = t1[7];
  __binding8 = __t.contentBind$2(new $.init_autogenerated_closure4(), false);
  __e9 = $.clone$1$x(__html3, true);
  t2.push($.ConditionalTemplate$(__e9, new $.init_autogenerated_closure5(), new $.init_autogenerated_closure6(__html4)));
  __e10 = $.clone$1$x(__html5, true);
  t2.push($.ConditionalTemplate$(__e10, new $.init_autogenerated_closure7(), new $.init_autogenerated_closure8(__html6)));
  $.addAll$1$ax($.get$nodes$x(__e11), [document.createTextNode("\n      "), $.clone$1$x(__html2, true), __binding8, document.createTextNode("\n      "), __e9, document.createTextNode("\n      "), __e10, document.createTextNode("\n    ")]);
  __t.create$0();
  __t.insert$0(__t);
};
...
$.CellComponent$ = function() {
  return new $.CellComponent(null, null, null, 0, null, null, $.makeLiteralMap([]));
};
...
$.ShowHide__requestEffect = function(doShow, element, desiredDuration, effect, effectTiming) {
  if (desiredDuration == null)
    desiredDuration = 400;
  else if ($.JSNull_methods.$lt(desiredDuration, 0))
    desiredDuration = 0;
...
$.ShowHide__requestShow = function(element, desiredDuration, effect, effectTiming) {
  ...
  if ($.$gt$n(durationMS, 0)) {
    ...
    value._timer = $.TimerImpl$(milliseconds < 0 ? 0 : milliseconds, t2);
...
Isolate.$lazy($, "__shadowTemplate", "Dropdown___shadowTemplate", "get$Dropdown___shadowTemplate", function() {
  return $.DocumentFragment_DocumentFragment$html("        <div class=\"dropdown\">\n          <content></content>\n        </div>\n      ");
});
Isolate.$lazy($, "_effect", "Dropdown__effect", "get$Dropdown__effect", function() {
  return $.FadeEffect$();
});
Isolate.$lazy($, "__html1", "CellComponent___html1", "get$CellComponent___html1", function() {
  return $.Element_Element$html("<div class=\"game-cell \" template=\"\" instantiate=\"if contents>0\"></div>");
});
Isolate.$lazy($, "__html2", "CellComponent___html2", "get$CellComponent___html2", function() {
  return $.Element_Element$html("<div class=\"empty-cell\" template=\"\" instantiate=\"if contents==0\"></div>");
});
Isolate.$lazy($, "__shadowTemplate", "CellComponent___shadowTemplate", "get$CellComponent___shadowTemplate", function() {
...
//@ sourceMappingURL=cascade.html_bootstrap.dart.js.map
